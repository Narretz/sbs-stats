...
class TestBreakdown:
    ...
    def test_headline_short_unit_бпла(self):
        ...
        # _UNIT_NOUN alternation. Intro phrase kept so the AD gate's
        # "беспилотн" token requirement is satisfied.
        r = _parse(
            "В течение прошедшей ночи при попытке киевского режима с применением "
            "беспилотных летательных аппаратов дежурными средствами ПВО уничтожены "
            "три украинских БпЛА самолетного типа над территориями Белгородской, "
            "Курской и Тульской областей.",
    ...
    def test_headline_paired_verb(self):
        ...
        r = _parse(
            "В течение прошедшей ночи при попытке киевского режима с применением "
            "беспилотных летательных аппаратов дежурными средствами ПВО уничтожено "
            "и перехвачено 47 украинских БпЛА самолетного типа. "
